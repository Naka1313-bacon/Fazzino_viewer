...
export function BloomEffect(graphicsDevice) {
    ...
    var extractFrag = [
        ...
        "    color.xyz *= color.w == 0.0 ? vec3(0.0) : vec3(1.2, 1.0, 0.8);",
...
BloomEffect.prototype.render = function (inputTarget, outputTarget, rect) {
...
export function registerBloomScript() {
